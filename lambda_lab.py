...
sorted_by_name = sorted(people, key=lambda _: _["name"].lower())
...
name_declarations = list(map(lambda _: f'{_["name"]} is {_["age"]} years old', sorted_by_name))
...
under_seventy = sorted(filter(lambda _: _['age'] < 70, sorted_by_name), key=lambda _: _['age'])
